...
// 横屏提示元素（需在index.html中添加）
// <div id="rotateTip" style="display:none;position:fixed;z-index:9999;left:0;top:0;width:100vw;height:100vh;background:rgba(0,0,0,0.85);color:#fff;align-items:center;justify-content:center;font-size:2rem;">请将手机横屏以获得最佳体验</div>
...
function resizeCanvas() {
  ...
  if (h > w) {
    // 竖屏
    if (rotateTip) rotateTip.style.display = 'flex';
